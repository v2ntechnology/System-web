...
export const SAAS_NAVIGATION: NavGroup[] = [
  {
    ...
    items: [
      ...
      /* Logo abaixo da visão geral de propósito: é a única tela do backoffice
         com fila esperando alguém, e é por onde a plataforma ganha cliente. */
      {
        label: 'Solicitações',
        path: '/admin-saas/solicitacoes',
        icon: InboxIcon,
        moduleKey: 'saas',
        permission: 'saas.manage',
      },
  ...
  },
  {
    ...
    items: [
      {
        label: 'Telemetria',
        path: '/admin-saas/telemetria',
        icon: SatelliteIcon,
        moduleKey: 'saas',
        permission: 'saas.manage',
      },
      {
        label: 'Equipe RookHub',
        path: '/admin-saas/equipe',
