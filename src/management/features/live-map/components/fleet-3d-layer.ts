...
export function criarFleet3dLayer(
  ...
  function animarReplay(marcador: Marcador, escalaAtual: number) {
    ...
    /* ⚠️ Módulo de uma volta. O acumulador cresce enquanto o replay corre, e a
       velocidade do marcador é alta (o trajeto de um dia cabe em dez minutos a
       1x, e em dois a 4x): sem isto ele chega à casa dos milhões, onde o
       `float32` da GPU já não distingue um quadro do seguinte e o giro passa a
       andar aos trancos. */
