...
export default function SettingsPage() {
  ...
  return (
    <div>
      {/* `bleed={false}`: tela de formulário não tem número de abertura, e sem a
          fileira embaixo a faixa não precisa do respiro para ser mordida. */}
      <PageHero
        title="Configurações"
      ...
      <PagePanel className="mt-6 space-y-6">
            ...
            <div className="min-w-0 flex-1">
              <TabsContent value="company" className="mt-0 grid gap-4 xl:grid-cols-3">
                <LightCard
                  ...
                  description="Informações cadastrais do tenant ativo."
                >
                ...
                <LightCard title="Assinatura" description="Situação atual do tenant na plataforma.">
                  <div>
              ...
              <TabsContent value="users" className="mt-0">
                <LightCard
                  ...
                  description="Membros com acesso à plataforma."
                >
                  <div>
                    <Table>
                      <TableHeader>
              ...
              <TabsContent value="units" className="mt-0">
                <LightCard title="Unidades operacionais" description="Filiais e bases da operação.">
              ...
              <TabsContent value="alerts" className="mt-0">
                <LightCard
                  ...
                  description="Escolha quais alertas devem gerar notificações."
                >
                  <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <TabsContent value="appearance" className="mt-0">
                <LightCard
                  title="Aparência"
                  description="O RookHub está sendo refeito no tema claro. O escuro volta em seguida."
                >
                  <div>
              ...
              <TabsContent value="security" className="mt-0 grid gap-4 xl:grid-cols-2">
                <LightCard title="Segurança" description="Proteções da conta e da sessão.">
                ...
                <LightCard
                  ...
                  description="Onde o controle de acesso realmente vale."
                >
              ...
              <TabsContent value="audit" className="mt-0">
                <LightCard title="Auditoria" description="Eventos recentes de configuração.">
                  <div className="space-y-2">
                    {[
